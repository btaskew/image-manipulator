<div class="border border-3 rounded p-8 bg-white mt-4 mb-4" xmlns:wire="http://www.w3.org/1999/xhtml">
    ...
    <div class="mt-4">
        <div class="flex flex-col">
            ...
            <label
                class="mt-3 mb-3 w-90 flex flex-col items-center px-4 py-6 bg-gray-100 rounded-lg shadow-sm border border-blue cursor-pointer hover:font-bold"
                for="image"
            >
            ...
            <span wire:loading wire:target="image" class="text-teal-700 font-semibold mt-3">Uploading image...</span>

            @if ($image)
                <span class="text-teal-700 font-semibold mt-3">Image preview:</span>
            ...
            <button
                class="mt-8 bg-teal-500 hover:bg-teal-700 text-white font-bold py-2 px-4 rounded"
                wire:click="useImage"
            >
                Use Image
            </button>
